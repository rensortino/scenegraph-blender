...
def main():
    collection_name = 'SG_Objects'
    bpy.ops.object.delete()
    object_classes = ['cube', 'cylinder', 'cone', 'sphere']
    n_objs = 4
    objects = [random.choice(object_classes) for _ in range(n_objs)]
    relationships = [
        [0, 'left to', 1],
        [2, 'left to', 3],
#        [0, 'left to', 3],
...
#        [1, 'below', 0]
    ...
    obj_collection = get_or_create_collection(collection_name)
    ...
    select_objects_in_collection(collection_name)